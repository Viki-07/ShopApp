...
class _CardsScreenState extends State<CardsScreen> {
  ...
  void initState() {
    super.initState();
   final userCard=Provider.of<CardProvider>(context, listen: false)
        .userCard;
    cardCvvController.text=userCard['cardCvv'];
    cardExpiryDateController.text=userCard['cardExpiryDate'];
    cardHolderNameController.text=userCard['cardHolderName'];
    cardNumberController.text=userCard['cardNumber'];
  }
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    await userCardProvider.updateCard(cardNumberController.text, cardHolderNameController.text, cardExpiryDateController.text, cardCvvController.text);
